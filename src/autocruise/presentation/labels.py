...
TEXTS = {
    "en": {
        ...
        "label.max_steps": "Max steps per run",
        ...
        "message.max_steps_hint": "Leave this blank for unlimited steps. Enter a number only if you want AutoCruise to stop after a fixed number of steps.",
        "history.flow": "Flow",
        ...
        "settings.general_subtitle": "Language, autonomy, run limits, and shortcuts",
    ...
    "ja": {
        ...
        "label.max_steps": "1 実行あたりの最大ステップ数",
        ...
        "message.max_steps_hint": "空欄なら無制限です。固定のステップ数で止めたい場合だけ数値を入力して下さい。",
        "history.flow": "フロー",
        ...
        "settings.general_subtitle": "表示言語、自律度、実行上限、ショートカットを設定します",
