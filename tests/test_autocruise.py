...
class AutoCruiseTests(unittest.TestCase):
    ...
    def test_windows_distribution_files_exist(self) -> None:
        ...
        self.assertIn("users/default/systemprompt", spec_text)
        self.assertIn("APP_NAME", spec_text)
        self.assertNotIn('"models"', spec_text)
        self.assertNotIn('"runtime"', spec_text)
        self.assertNotIn("uia_query.ps1", spec_text)
